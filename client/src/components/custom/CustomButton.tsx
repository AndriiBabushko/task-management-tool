...
export const CustomButton: FC<ICustomButtonProps> = ({ buttonText, buttonType, bgColor, hoverColor, onClickHandler, onSubmitHandler }) => {
  return (
    <button
      ...
      ${hoverColor ? hoverColor : 'hover:bg-green-800'} focus:outline-none focus-visible:ring-2 transition-colors
      duration-300 ease-in-out focus-visible:ring-white focus-visible:ring-opacity-75 active:bg-opacity-50`}
      type={buttonType}
