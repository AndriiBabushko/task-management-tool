...
const { mongooseModel: taskModel, TaskModel } = require("../models/task-model");
const { mongooseModel: userModel } = require("../models/user-model");
...
describe("Task App", () => {
  ...
  let token, user1ID, user2ID, task1ID, task2ID, task3ID;
